<?php
    ...
    # refreshing message
    $errorRefreshMessage = "<span class='d-md-inline-block d-none'>, Refresh to continue </span><a href='patient.php' class='float-end fw-bold text-danger'><i class='bi bi-arrow-clockwise me-3'></i></a>";

    $successRefreshMessage = "<span class='d-md-inline-block d-none'>, Refresh to see the change </span><a href='patient.php' class='float-end fw-bold text-success'><i class='bi bi-arrow-clockwise me-3'></i></a>";
        ...
        # otherwise proceed with registration process
            ...
            # Check if $uploadOk is set to 0 by an error
                ...
                if (move_uploaded_file($_FILES["cashier_profile"]["tmp_name"], $target_file)) {
                    ...
                    $sql_insert_cashier = " INSERT INTO `cashier`(`created_at`, `cashier_name`, `cashier_username`, `cashier_mail`, `cashier_password`, `cashier_pin`, `photo`, `cashier_balance`, `status`) VALUES(:adate, :cashier_name, :cashier_uname, :cashier_mail, :cashier_password, :cashier_pin, :photo, :balance, :bstatus)";
